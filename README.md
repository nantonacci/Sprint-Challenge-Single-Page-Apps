...
- [ ] Explain benefit(s) using `client-side routing`?
  > Answer: Reusing DOM elements, less data intensive, benefits of a single page application
- [ ] What does AJAX stand for?
  > Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
  > Answer: State becomes a "single source of truth" when React controls the form render and what happens with the input on the form
